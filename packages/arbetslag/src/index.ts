...
import { contentText, ContentPart } from "./application/agent/history";
...
export type { ContentPart } from "./application/agent/history";
export { contentText } from "./application/agent/history";
